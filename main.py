...
def generate_data():
    ...
    print('Done Generation. Exiting generate_data() method...')
...
def main():
    print('In main() method, Starting the program...')
    print('Call to generate data...')
    # Generating Data; generate_data() returns the training and test sets
    X_train, X_test, y_train, y_test = generate_data()
    
    print('Call to create MultiLayerPerceptron with input_shape: {}'.format(X_train.shape[1]))
    ...
    network.train(X_train, y_train, learning_rate = 0.1, epochs = 90)
